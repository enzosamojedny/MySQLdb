Este es un template en construcción para un comercio genérico, usando MySQL como base de datos temporalmente para luego reemplazarlo por SQL Server para así
